        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4">
            <div class="nav navbar-nav" style="padding: 40px 10px;">
              <a class="btn btn-social-icon btn-facebook" href="http://www.facebook.com/ashinshanly"><i class="fa fa-facebook fa-2x"></i></a>
              
              <a class="btn btn-social-icon btn-youtube" href="http://youtube.com/"><i class="fa fa-youtube fa-2x"></i></a>
              <a class="btn btn-social-icon" href="http://www.gmail.com"><i class="fa fa-envelope-o fa-2x"></i></a>
            </div>
          </div>
          <div class="col-xs-12">
            <p style="padding:20px;"></p>
            <p align=center>Copyright © 2018 AshinShanly</p>
          </div>
        </div>
      </div>
    </footer>
