					...
					<form name="bookingForm" id="bookingForm" action="booksuccess.php" method="POST" novalidate>
						<div class="control-group form-group">
							<div class="controls">
								...
								<select class="form-control" id="timing" name="timing" required>
									<option value="10:00 AM" name="timing1" selected>10:00 AM</option>
									<option value="12:30 PM" name="timing2">12:30 PM</option>
									<option value="3:00 PM" name="timing3">3:00 PM</option>
									<option value="6:00 PM" name="timing4">6:00 PM</option>
								</select>
						...
						<div class="control-group form-group">
							<div class="controls">
								...
								<input type="number" min="1" max="10" class="form-control" id="ticket" name="ticket" value="1" required>
							</div>
						</div>
						<div id="visible">
						...
						<div id="invisible">
							...
							<h3 class="text-center" style="min-height:80px;">
							<strong>Total Amount:</strong>
							<p id="amountTotal" name="amountTotal">&#8377; 120.00</p>
