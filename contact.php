...
<html lang="en">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <p>
          GOVERNMENT ENGINEERING COLLEGE THRISSUR<br>KERALA, INDIA<br>
        </p>
        ...
        <ul class="list-unstyled list-inline list-social-icons">
          <li>
            <a class="text-danger" href="http://www.facebook.com/ashinshanly"><i class="fa fa-facebook-square fa-2x"></i></a>
          </li>
          
          <li>
            <a class="text-danger" href="https://plus.google.com/u/0/114188664766443379827"><i class="fa fa-google-plus-square fa-2x"></i></a>
          </li>
        </ul>
      </div>
    </div>
